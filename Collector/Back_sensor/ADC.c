...
int ADC_value[]={500,500,700,725,725,700,700,700};
...
//		if(full_sense==1)
		{
			if(counter>4 || (ADC_result>12 && ADC_result<18))
			{
...
//		else if(full_sense==0)
		{
//			PORTB = (ADC_result & 0b00011111)<<3; 
/*			if(ADC_result>11 && ADC_result<22)
			{
				COM_PORT |= _BV(OUT_MAIN);
				_delay_us(15);
			}
